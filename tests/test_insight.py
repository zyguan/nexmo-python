...
def test_get_basic_number_insight(client, dummy_data):
    ...
    assert isinstance(
        client.get_basic_number_insight(number='447525856424'), dict)
...
def test_get_standard_number_insight(client, dummy_data):
    ...
    assert isinstance(
        client.get_standard_number_insight(number='447525856424'), dict)
    assert request_user_agent() == dummy_data.user_agent
    assert 'number=447525856424' in request_query()
...
def test_get_advanced_number_insight(client, dummy_data):
    ...
    assert isinstance(
        client.get_advanced_number_insight(number='447525856424'), dict)
    assert request_user_agent() == dummy_data.user_agent
    assert 'number=447525856424' in request_query()
